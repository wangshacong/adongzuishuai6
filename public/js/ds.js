    ...
    ! function () {
        ...
        s.setPath('https://dup.baidustatic.com/'), s.define({
            ...
            checkBrowser: function () {
                ...
                for (var n = ["Android", "iPad", "iPod", "iPhone", "iOS", "Linux", "Macintosh", "Windows"], o = "", s = 0; s < n.length; s++)
                    if (o = n[s], t.match(new RegExp(o, "i"))) {
            ...
            forEach: function (t, e) {
                ...
                if ("function" == typeof e)
                    for (o = 0; s > o && (n = t[o], i = e.call(t, n, o), i !== !1); o++);
                return t
            },
            ...
            off: function (t, e, i) {
                ...
                if (e.indexOf("on") && (e = "on" + e), o = s[e], "undefined" == typeof i) delete s[e];
                else if (o)
            ...
            getSlotType: function (t) {
                ...
                if ((this.inlayFixAssert.assert(i) || this.dynamicFloatAssert.assert(i)) && (e = this.TYPE.INLAY), n && n.fillstyle)
                    for (var o = i.placement.fillstyle.elements || [], s = 0, r = o.length; r > s; s++)
                        if (5 === o[s]) return this.TYPE.LINKUNIT;
                return e
            }
        }), s.define({
            name: "landingPage",
            ...
            sendLogRequest: function (t) {
                ...
                window[n] = e, e.onload = e.onerror = e.onabort = function () {
                        ...
                        e = null
                    }, t += t.indexOf("?") > -1 ? "&" : "?", t += "stamp=" + Math.random(),
                    e.src = t
            },
            sendLog: function (t) {
            ...
            onMessageHandler: function (t) {
                ...
                if (e && e.tuid) {
                    var i = t.origin || t.originalEvent.origin,
                        n = i && i.split("//")[1],
                        o = t.source;
                    if (e.placement && e.placement.update && e.queryid) this.updateInfo(e), e.tuid.indexOf("u") > -1 && e.noadx && parseInt(e.noadx, 10) && 3 !== parseInt(e.noadx, 10) && this.unionAdIsAvailable(e);
            ...
            processSlotInfo: function (t) {
                ...
                return ("-1" === t.pcwd || t.ftpc || t.styleOpenApi.cpro_ftpc) && (r = "-1" === t.pcwd && "-1" === t.pchd ? 8 : 5), c.sizeType && (r = c.sizeType && parseInt(c.sizeType, 10) || r, a = c.width && parseInt(c.width, 10) || a, d = c.height && parseInt(c.height, 10) || d), 1 === r ? e = {
                    width: a,
                    height: d
                    ...
                    width: l.width || 0,
                    height: l.height || 0
                }), 2 !== c.apType && 3 !== c.apType || (s.location = c.apType), e.sizeType = r, t.width = e.width, t.height = e.height, e
            }
        }), s.define({
            name: "detect",
            namespace: "dup.business",
                ...
                try {
                    ...
                    if (t) {
                        var o, s = 200,
                            r = (new Date).getTime();
                        if (this.browser.ie)
                            for (o = r + s; o > r;) r = (new Date).getTime();
                        else {
            ...
            launch: function () {
                ...
                if (window.cpro_mobile_slot = null, s)
            ...
            launch: function () {
                try {
                    if (!window.___baidu_union_.expId) {
                        window.___baidu_union_.expId = this.getAutoExpId();
                        var t = this.getDisParam();
                        if ("110011" === window.___baidu_union_.expId && 0 === t) {
                    ...
                    var n = i && i.stack ? i.stack : i,
                        o = this.config.LOG_URL;
                    o += "?type=autoAds", o += "&date=" + (new Date).getTime(), o += "&mes=" + encodeURIComponent(n), (new Image).src = o
                }
            },
            getAutoExpId: function () {
                var t, e = 1e4 * Math.random();
                return t = 3e3 > e ? "110011" : e >= 3e3 && 6e3 > e ? "110010" : "110000"
            },
            ...
            callback: function (t, e, i) {
                try {
                    ...
                    var s = o && o.stack ? o.stack : o,
                        r = this.config.LOG_URL;
                    r += "?type=fatalError", r += "&key=autoDupCallback", r += "&date=" + (new Date).getTime(), r += "&mes=" + encodeURIComponent(s), (new Image).src = r
                }
            },
            ...
            getAutoScriptSnippet: function (t, e, i) {
                var n = '(window.slotbydup = window.slotbydup || []).push({ id: "' + t + '", container:"' + e + '"',
                    o = "});",
                    s = n + o;
                return i = window.JSON && window.JSON.stringify && i && "object" == typeof i && JSON.stringify(i), i && (s = n + ", coa:" + i + o), s
            },
            getDisParam: function () {
                for (var t = this.slotParam.paramsList, e = 0; e < t.length; e++)
                    if ("dis" === t[e].key) return s.proxy(this.slotParam, t[e].value)()
            }
        }), s.define({
            name: "frame",
            namespace: "dup.business",
            ...
            containerFilter: function (t) {
                var e = !1,
                    ...
                    n = i.container,
                    o = n.location,
                    s = t.styleOpenApi && 2 === t.styleOpenApi.apType;
                if (2 === o && !s) return !1;
                var r = 3.4;
                if (1 !== n.sizeType) {
                ...
                if (t.styleOpenApi) {
                    ...
                    if (t.styleOpenApi.scale) {
                        var c = t.styleOpenApi.scale.split("."),
                            h = c[0] / c[1];
                        e = !(r > h)
                    }
                }
            ...
            parseCloseBtnLayoutData: function (t) {
                var e = "",
                    ...
                    n = "0",
                    o = 0;
                2 === t.locationType ? (e = "borderRadius" in document.documentElement.style ? "0 0 40px 40px" : e, n = t.height, i = t.styleOpenApi && t.floatingState !== this.directDisplay ? String.fromCharCode(65088) : String.fromCharCode(65087), o = -4) : (e = "borderRadius" in document.documentElement.style ? "40px 40px 0 0" : e, n = -20, i = t.styleOpenApi && t.floatingState !== this.directDisplay ? String.fromCharCode(65087) : String.fromCharCode(65088), o = 3);
                var s = {
                    domId: t.containerId,
                    borderRadius: e,
                    top: n,
            ...
            decorateContainer: function (t, e) {
                if (t) {
                    var i = 0,
                        n = "absolute";
                    this.style.canFixed() && (n = "fixed", i = e.floatingState !== this.directDisplay && "ontouchend" in document ? e.height && -1 * (e.height + 19) : 0), "absolute" === n && (i = this.style.getScrollTop(window) + this.style.getClientHeight(window) - e.height);
            ...
            closeBtnOnClickHandler: function (t, e, i) {
                ...
                if (n && n.parentNode) {
                    var o = 0,
                        s = 2 === i.locationType ? "top" : "bottom";
                    o = this.style.getStyle(n, s), o = o && parseInt(o, 10), 0 === o ? this.hideAdContainer(s, n, o) : this.showAdContainer(s, n, o)
                }
                if (2 === e.closeType) {
                    var r = "bd_close_" + this.id,
                        a = {
                            path: ""
                        };
                    this.cookie.set(r, !0, a)
                }
            },
            showAdContainer: function (t, e, i) {
                var n = t && setInterval(function () {
                    if (0 > i) e.style[t] = ++i + "px";
                    else {
                        clearInterval(n);
                        var o = e.id,
                            s = o && o + "_closebtn_inside",
                            r = document.getElementById(s);
                        r.style.marginTop = "top" === t ? "-4px" : "3px", r.innerText = "top" === t ? String.fromCharCode(65087) : String.fromCharCode(65088)
                    }
                }, 10)
            },
            hideAdContainer: function (t, e, i) {
                ...
                var o = t && setInterval(function () {
                    if (i > -1 * n) e.style[t] = --i + "px";
                    else {
                        clearInterval(o);
                        var s = e.id,
                            r = s && s + "_closebtn_inside",
                            a = document.getElementById(r);
                        a.style.marginTop = "top" === t ? "3px" : "-4px", a.innerText = "top" === t ? String.fromCharCode(65088) : String.fromCharCode(65087)
                    }
                }, 10)
            },
            validate: function (t) {
                    ...
                    if (!i) {
                        ...
                        if (n && (t.width = e.width, t.height = e.height, this.containerFilter(t))) {
                            ...
                            if (2 === e.sizeType) {
                                ...
                                this.data.defineOnce("BAIDU_SSP_floatShow", s.proxy(this, this.showFloatAd))
                            }
                            var d = {
                                    id: t.id,
                                    width: n.clientWidth,
                            ...
                            c && this.dom.bind(c, "click", s.proxy(this, this.closeBtnOnClickHandler, t, e)), this.hiddenFloatAd.render(t), t.isPdbAd || this.slot.setStatus(t.id, this.config.STATUS_FINISH)
                        }
                    }
                }
            },
            ...
            touchEnd: function (t, e, i, n) {
                ...
                if (this.pageY < this.startY && -10 > o && !this[i] && n === this.upSlideAnimation || this.pageY > this.startY && o > 10 && !this[i] && n === this.downSlideAnimation) {
                    this[i] = !0;
                    var s = document.getElementById(e),
                        r = this.style.getStyle(s, i);
                    r = r && parseInt(r, 10), this.showAdContainer(i, s, r)
                }
            },
