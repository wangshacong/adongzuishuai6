...
class HomeController extends Controller
{
    ...
    {
        $fenlei=Fenlei6::all();
        $dangqian_fenlei = Fenlei6::where('id',$id)->first();
        $article = Article6::orderBy('id','desc')->where('fenlei_id','=',$id)->paginate(6);
        $lunbo = Article6::orderBy('id','desc')->where('fenlei_id',$id)->where('news_pic','<>','')->limit(6)->get();
    ...
    {
        $fenlei = Fenlei6::all();
        $content = Article6::where('id','=',$id)->first();
